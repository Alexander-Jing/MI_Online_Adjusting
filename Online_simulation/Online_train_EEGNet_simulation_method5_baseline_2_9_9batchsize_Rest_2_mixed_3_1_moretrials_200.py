...
def Online_updating_EEGLM_simulation(args_dict):
    ...
    for label in unique_labels:
        ...
        selected_indices = indices[:200*3]
    ...
    _n_epoch_online = int(n_epoch_online/2)
        ...
        if (trial_idx + 1) % update_wholeModel == 0:           
            ...
            for epoch in trange(_n_epoch_online, desc='online classification update'):
                ...
                while initial_A < 1.0:
                    ...
                    # first, calaulate the loss of each sample for selection via quantile lambda of each class, different from the CSP-SVM form, here we only use the CE loss as the losstmp
