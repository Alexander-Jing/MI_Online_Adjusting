...
def Offline_EEGNet_simulation(args_dict):
    ...
    sub_train_feature_array, sub_train_label_array, sub_val_feature_array, sub_val_label_array, \
        sub_train_feature_array_1, sub_train_label_array_1 = Online_simulation_read_csv_windows_preprocess_normalization_part_1(folder_path=Offline_folder_path, sub_file=sub_name, trial_pre_1=60, trial_pre_2=140, trial_pre_3=200, preprocess=preprocess_norm, proportion=proportion)
...
def Online_updating_EEGNet_simulation(args_dict):
    ...
    sub_train_feature_array, sub_train_label_array, sub_val_feature_array, sub_val_label_array, \
        sub_train_feature_array_1, sub_train_label_array_1 = Online_simulation_read_csv_windows_preprocess_normalization_part_1(folder_path=Offline_folder_path, sub_file=sub_name, trial_pre_1=60, trial_pre_2=140, trial_pre_3=200, preprocess=preprocess_norm,\
