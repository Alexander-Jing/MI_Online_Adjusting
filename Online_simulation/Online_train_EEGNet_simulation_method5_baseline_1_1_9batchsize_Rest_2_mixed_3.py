...
def Online_updating_EEGNet_simulation(args_dict):
    ...
    for trial_idx in range(trial_nums):
        ...
        for label in unique_labels:
            ...
            # while 2*batch_size_online (default set as 18) latest EEG segments as the validation data for the other two categories
            if label != train_label_now_:
                ...
                selected_indices_val = indices[-batch_size_online:]
                selected_indices_train = indices[-2*batch_size_online:]
