...
from helpers.brain_data import Offline_read_csv, brain_dataset, Online_read_csv, Online_simulation_read_csv, Online_simulation_read_csv_windows_preprocess_normalization_part_1
...
def Offline_EEGNet_simulation(args_dict):
    ...
    sub_train_feature_array, sub_train_label_array, sub_val_feature_array, sub_val_label_array, \
        sub_train_feature_array_1, sub_train_label_array_1 = Online_simulation_read_csv_windows_preprocess_normalization_part_1(folder_path=Offline_folder_path, sub_file=sub_name, trial_pre_1=0, trial_pre_2=40, trial_pre_3=50, preprocess=preprocess_norm, proportion=proportion)
...
def Online_updating_EEGNet_simulation(args_dict):
    ...
    sub_train_feature_array, sub_train_label_array, sub_val_feature_array, sub_val_label_array, \
        sub_train_feature_array_1, sub_train_label_array_1 = Online_simulation_read_csv_windows_preprocess_normalization_part_1(folder_path=Offline_folder_path, sub_file=sub_name, trial_pre_1=0, trial_pre_2=40, trial_pre_3=50, preprocess=preprocess_norm,\
...
def Online_data_painiting(args_dict):
    ...
    sub_train_feature_array, sub_train_label_array, sub_val_feature_array, sub_val_label_array, \
        sub_train_feature_array_1, sub_train_label_array_1 = Online_simulation_read_csv_windows_preprocess_normalization_part_1(folder_path=Offline_folder_path, sub_file=sub_name, trial_pre_1=0, trial_pre_2=40, trial_pre_3=50, \
                                                                                                proportion=proportion, batch_size_online=batch_size_online, \
                                                                                                    pattern=  [1, 2, 1, 2, 0, 0, 2, 2, 1, 1, 0, 0, 
                                                                                                               2, 1, 1, 2, 0, 0, 1, 2, 2, 1, 0, 0, 
                                                                                                               2, 2, 2, 1, 0, 0, 1, 2, 1, 1, 0, 0, 
