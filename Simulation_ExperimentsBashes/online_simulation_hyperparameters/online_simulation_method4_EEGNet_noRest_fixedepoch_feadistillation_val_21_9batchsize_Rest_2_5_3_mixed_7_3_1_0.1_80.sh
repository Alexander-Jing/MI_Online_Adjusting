...
do
  ...
  python3 $program_path \
    ...
    --Online_result_save_rootdir "Online_simulation_experiments/seed3407/hyperparameters/method4_EEGNet_fixedepoch_FeatureDistillation_val_21_9batchsize_Rest_2_lessepoch_1_8_mixed_7_new_3_3_1_seed3407_0.1_80" \
