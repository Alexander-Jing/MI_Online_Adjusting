...
do
  ...
  python3 $program_path \
    ...
    --Online_result_save_rootdir "Online_simulation_experiments/method4_EEGNet_fixedepoch_FeatureDistillation_val_9batchsize_Rest_2_mixed_retrain_1_3_new_seed3407" \
    --restore_file "None" \
    --n_epoch_offline 32 \
    --n_epoch_online  32 \
    --batch_size 32 \
